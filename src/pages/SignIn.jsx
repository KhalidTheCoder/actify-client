...
const SignIn = () => {
  ...
  return (
    ...
    >
      <div
        className="flex flex-col md:flex-row justify-center items-center gap-8 w-full max-w-6xl"
        data-aos="fade-up"
      >
        ...
        >
          ...
          <div className="flex items-center w-full my-4" data-aos="fade-in">
            <hr className="w-full border-gray-400" />
            <p className="px-2 text-gray-600 text-sm">OR</p>
            <hr className="w-full border-gray-400" />
          </div>

          <form onSubmit={handleSignIn} className="space-y-5" data-aos="fade-up">
            <div>
              <label
                htmlFor="email"
